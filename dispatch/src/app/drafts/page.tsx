      ...
      <header className="bg-blue-950 text-white px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6 text-sm">
            <Link href="/capture" className="text-blue-300 hover:text-white transition-colors">Onboarding</Link>
            <Link href="/posts" className="text-blue-300 hover:text-white transition-colors">Posts</Link>
            <Link href="/suggest" className="text-blue-300 hover:text-white transition-colors">Suggest</Link>
            <Link href="/draft" className="text-blue-300 hover:text-white transition-colors">Draft</Link>
            <Link href="/drafts" className="text-white font-medium border-b border-blue-400 pb-0.5">Drafts</Link>
            <Link href="/cascade" className="text-blue-300 hover:text-white transition-colors">Cascade</Link>
          </nav>
        </div>
      </header>
