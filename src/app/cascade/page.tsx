      ...
      <header style={{ backgroundColor: BLUE }} className="text-white px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6 text-sm">
            ...
            <Link href="/drafts" className="text-white/70 hover:text-white transition-opacity">Drafts</Link>
            <Link href="/cascade" className="text-white font-medium border-b border-white/60 pb-0.5">Cascade</Link>
          </nav>
        </div>
      </header>
